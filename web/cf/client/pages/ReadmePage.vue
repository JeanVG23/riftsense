  ...
  <template v-if="tab === 'data'">
    <div>
      ...
      <div class="card">
        ...
        <p class="faint" style="margin-top:10px">account-v1 et match-v5 utilisent le routing <strong>régional</strong> (europe/americas/asia) ; league-v4 et mastery utilisent le routing <strong>plateforme</strong> (euw1…). Clé de production : pas de rate-limiting agressif nécessaire, juste un backoff poli sur 429.</p>
      </div>
